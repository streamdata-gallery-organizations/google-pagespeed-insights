...
- name: Google PageSpeed Insights API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-pagespeed-insights/master/_listings/google-pagespeed-insights/runpagespeed-get.md
x-common:
- type: x-change-logs
